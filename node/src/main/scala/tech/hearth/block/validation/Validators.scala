package tech.hearth.block.validation

import cats.syntax.either.*
import tech.hearth.block.Block.{GenerationVRFSignatureLength, MaxFeaturesInBlock}
import tech.hearth.block.{Block, MicroBlock}
import tech.hearth.crypto
import tech.hearth.crypto.{DigestLength, KeyLength}
import tech.hearth.mining.Miner.MaxTransactionsPerMicroblock
