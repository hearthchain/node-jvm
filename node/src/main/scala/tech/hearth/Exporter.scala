...
import tech.hearth.database.protobuf.BlockMeta
import tech.hearth.database.{KeyTag, RDB, createBlock, readBlockMeta, readTransaction}
...
object Exporter extends ScorexLogging {
  ...
  private lazy val commandParser = {
    ...
    OParser.sequence(
      programName("hearth export"),
      head("Hearth Blockchain Exporter", Version.VersionString),
      opt[File]('c', "config")
