...
import tech.hearth.state.{BlockEndorser, Blockchain, BlockchainUpdaterImpl, Height, ParSignatureChecker}
      ...
      case Formats.Binary =>
        ...
        rdb.db.iterateOver(KeyTag.BlockInfoAtHeight) { e =>
          e.getKey match {
            ...
            case _ =>
              val meta = tech.hearth.database.readBlockMeta(e.getValue)
