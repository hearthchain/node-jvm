...
- Touching StakeTransaction, StakeRecord, StakingPayout, the per-period payout to stakers, or `FunctionalitySettings.credAsset`: read `docs/notes/cred-economy.md` first.
